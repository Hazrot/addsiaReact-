                                ...
                                <div className="card2 card border-0 px-4 py-5">
                                    ...
                                    <div className="row px-3 mb-4">
                                        <div className="custom-control custom-checkbox custom-control-inline"><input
                                            ...
                                            <label htmlFor="chk1" className="custom-control-label text-sm">Remember
                                                me</label></div>
                                    ...
                                    <div className="row mb-4 px-3"><small className="font-weight-bold">Don t have an
                                        account? <Link to={"/signUp"} className="text-danger ">Register</Link></small>
                                    </div>
                                </div>
                            </div>
                        </div>
